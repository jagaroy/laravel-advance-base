...
<div class="inner_body">
	<!-- <a href="{{ action('BrandController@create') }}" class="pull-right">
		...
		<tbody>
			...
			<tr data-info="{'dd':'ddd'}">
				...
				<td style="display: inline-flex;">
					<!-- <a href="{{action('BrandController@edit', $row['brand_id'])}}" class="btn btn-xs btn-primary pull-left" style="margin:0 12px 0 0;">  Edit  </a> -->

					<a href="#my-modal" id="edit_ajax" role="button" class="btn btn-xs btn-primary pull-left" data-toggle="modal" data-actions="{{ action('BrandController@update', $row['brand_id']) }}" data-info="<?php echo htmlentities(json_encode($row)); ?>" style="margin:0 12px 0 0;">Edit </a>

		        	<form action="{{action('BrandController@destroy', $row['brand_id'])}}" method="post" id="delete_form">
		        		{{csrf_field()}}
		        		<input name="_method" type="hidden" value="DELETE" />
						<input name="jsidentify" type="hidden" value="<?php echo $row['brand_id']; ?>" />						
			...
			<div class="modal-body">
				...
				<form method="post" action="" id="edit_form">
					<div class="form-group row">
						...
						<label for="brand_name" class="col-sm-2 col-form-label col-form-label-lg">Brand Name</label>
						<div class="col-sm-10">
							<input type="text" class="form-control form-control-lg" id="brand_name" placeholder="brand_name" name="brand_name" value="" autofocus="1">
						</div>
					</div>
					<div class="form-group row">
						<label for="brand_desc" class="col-sm-2 col-form-label col-form-label-sm">Brand Description</label>
						<div class="col-sm-10">
							<textarea id="brand_desc" name="brand_desc" rows="8" cols="50"></textarea>
						</div>
					</div>
					<div class="form-group row">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="add_form" method="post" class="form-horizontal" action="{{url('brands')}}">
					<div class="form-group">
						{{csrf_field()}}
						<label for="brand_name_add" class="col-sm-2 col-form-label col-form-label-lg control-label">Brand Name:</label>
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-lg" id="brand_name_add" placeholder="title" name="brand_name">
						</div>
					</div>
					<div class="form-group">
						<label for="smFormGroupInput" class="col-sm-2 col-form-label col-form-label-sm control-label">Brand Description:</label>
						<div class="col-sm-8">
							<textarea name="brand_desc" rows="8" cols="50"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-2"></div>
